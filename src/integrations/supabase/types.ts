  ...
  public: {
    Tables: {
      ...
      daily_journals: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_journals_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      jewelry_set_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "jewelry_set_events_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      jewelry_sets: {
        ...
        Relationships: [
          {
            foreignKeyName: "jewelry_sets_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      product_origin_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_origin_events_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      product_quantity_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_quantity_events_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      scrap_gold: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "scrap_gold_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      scrap_gold_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "scrap_gold_events_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      tenant_access_keys: {
        ...
        Relationships: [
          {
            foreignKeyName: "tenant_access_keys_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
